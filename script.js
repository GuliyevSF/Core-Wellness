const data = {
  ladies: {
    ...
    Technologies: [
      ...
      },
      {
        ...
        short: "Focus: Weight Management, Peak Performance, Regeneration, Appearance",
        full: "This triple impact therapy combines long wave infrared rays, plasma and light for the ultimate in detox and weight loss therapy. It is proven to burn fats, accelerate metabolism, remove muscle and joint pain and improve blood circulation. "
      },
      {
    ...
    Hairsalon: [
      ...
      },
      {
        ...
        durations: [
          { time: "Short - 90 minutes", price: "575 SAR" },
          { time: "Medium - 120 minutes", price: "725 SAR" },
          { time: "Long - 120 minutes", price: "975 SAR" },
        ],
        short: "",
        full: ""
      },
      {
        title: "FULL HEAD HIGLIGHTS",
        durations: [
          { time: "Short - 120 minutes", price: "1100 SAR" },
          { time: "Medium - 180 minutes", price: "1425 SAR" },
          { time: "Long - 240 minutes", price: "1750 SAR" },
        ],
        short: "",
        full: ""
      },
      {
        title: "FULL HEAD LOWLIGHTS",
        durations: [
          { time: "Short - 120 minutes", price: "1100 SAR" },
          { time: "Medium - 180 minutes", price: "1550 SAR" },
          { time: "Long - 240 minutes", price: "1775 SAR" },
        ],
        short: "",
        full: ""
      },
      {
        title: "OMBRE",
        durations: [
          { time: "Short - 180 minutes", price: "1375 SAR" },
          { time: "Medium - 240 minutes", price: "1850 SAR" },
          { time: "Long - 240 minutes", price: "1900 SAR" },
        ],
        short: "",
        full: ""
      },
      {
        title: "CONTOUR",
        durations: [
          { time: "180 minutes", price: "825 SAR" },
        ],
        short: "",
        full: ""
      },
      ...
      {
        title: "CURLY WASH & STYLE",
        durations: [
          { time: "90 minutes", price: "400 SAR" },
        ],
        short: "",
        full: ""
      },
      ...
      {
        title: "NUTRITIVE PROTOCOL",
        durations: [
          { time: "45 minutes", price: "375 SAR" },
        ],
        short: "Kerastase Hair Treatment",
        full: "Nourishing and hydrating hair care regime, specially formulated to treat dry to severely dry hair, providing enhanced protection, moisture and softness."
      },
      {
      ...
      {
        title: "COLOR GLOSS ABSOLU TREATMENT",
        durations: [
          { time: "60 minutes", price: "400 SAR" },
        ],
        short: "Kerastase Hair Treatment",
        full: "A revolutionary, high-shine treatment, which works wonders on colored hair. It strengthens and seals the surface to protect color, provide intense softness and a high shine, glossy finish."
      },
    ],
    Nail: [
      {
  ...
  gentlemen: {
    ...
    Barber: [
      {
        title: "SHARP SHAVED DUO",
        durations: [
          { time: "50 minutes", price: "250 SAR" },
        ],
        short: "Hair & Beard",
        full: "Wash, razor head shave, lotion or balm, hot towel with essential oil, foam, razor beard shave, lotion or balm, hot towel, finishing cologne."
      },
      {
        title: "CLASSIC DUO",
        durations: [
      ...
      {
        title: "KEEP THEM SHORT DUO",
        durations: [
          { time: "50 minutes", price: "250 SAR" },
        ],
        short: "Hair & Beard",
        full: "Wash, clippers only cut, balm, hot towel with essential oil, foam, shape or shave beard, dry, finishing cologne."
      },
      {
        title: "SHARPE SHAVE HAIRCUT",
        durations: [
          { time: "30 minutes", price: "175 SAR" },
        ],
        short: "Hair",
        full: "Wash, razor head shave, lotion or balm, hot towel with essential oil, finishing cologne."
      },
      {
        ...
        short: "Hair",
        full: "Wash, classic cut, lotion or balm, hot towel with essential oil, wash, dry, finishing cologne."
      },
      {
      ...
      {
        title: "KEEP IT SHORT HAIRCUT",
        durations: [
          { time: "30 minutes", price: "175 SAR" },
        ],
        short: "Hair",
        full: "Wash, clippers only cut, balm, hot towel with essential oil, dry, finishing cologne."
      },
      {
        title: "SHARP SHAVE BEARD",
        durations: [
          { time: "20 minutes", price: "125 SAR" },
        ],
        short: "Beard",
        full: "Foam, razor beard shave, lotion or balm, oil, hot towel with essential oil, finishing cologneFoam, razor beard shave, lotion or balm, oil, hot towel with essential oil, finishing cologne."
      },
      {
      ...
      },
      {
        ...
        durations: [
          { time: "10 minutes", price: "Comlementary" },
        ],
        short: "Male Grooming",
        full: ""
      },
...
function updateBackground() {
  ...
  body.className = "page-menu";

  if (!currentCategory) {
    // sadəcə gender background
    body.classList.add(currentGender);
  } else {
    const category = toSlug(currentCategory);
    body.classList.add(`${currentGender}-${category}`);
  }
}
...
function buildCards() {
  ...
  data[currentGender][currentCategory].forEach((item, i) => {
...
function preloadImages() {
  const images = [
    "menu/corridor.webp",
    "menu/Treatment2.webp",
    "menu/tresament2.webp",
    "menu/Technology.webp",
    "menu/needtochange.png",
    "menu/Nail.webp",
    "menu/corridor.webp",
    "menu/Treatment2.webp",
    "menu/tresament2.webp",
